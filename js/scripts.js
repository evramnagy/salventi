            ...
            imagesLoaded('body', function() {
                ...
                setTimeout(function() {
                    ...
                    if ($(".showcase-gallery .slider-fixed-content #slide-inner-caption").hasClass("height-title")) {
                        ...
                        gsap.to($(".showcase-gallery .slider-fixed-content .slide-hero-subtitle.caption-timeline span"), {
                            duration: 0.7,
                            y: 0,
                            opacity: 1,
                            stagger: 0.1,
        ...
        if (!$("body").hasClass("disable-ajaxload")) {
            $('#page-nav .page-title').on('click', function() {
                ...
                if ($(".page-nav-caption").hasClass("height-title")) {
                    ...
                    gsap.to('.page-nav-caption .next-hero-subtitle.caption-timeline span', {
                        duration: 0.3,
                        y: -30,
                        opacity: 0,
                        delay: 0,
    ...
    function ShowcaseOverlapping() {
        ...
        if ($('.overlapping-gallery').length > 0) {
            ...
            $('.trigger-item').on('click', function() {
                ...
                gsap.to('footer, .slide-date, .slide-cat', {
                    duration: 0.5,
                    opacity: 0,
                    ease: Power2.easeIn
                });
                    ...
                    scrollTrigger: {
                        ...
                        onEnter: function() {
                            ...
                            if ($('body').hasClass("show-loader")) {
                                setTimeout(function() {
                                    gsap.to($(".showcase-portfolio .img-mask.animated .curtain-row"), {
                                        duration: 0.7,
                                        scaleY: 0,
                                        opacity: 0,
                                        stagger: 0.1,
        ...
        if ($('.showcase-gallery').length > 0) {
            ...
            const showGrid = () => {
                ...
                if ($(".showcase-gallery .slider-fixed-content #slide-inner-caption").hasClass("height-title")) {
                    ...
                    gsap.to($("#slide-inner-caption .caption-timeline span"), {
                        duration: 0.3,
                        y: -100,
                        opacity: 0,
                        stagger: 0.05,
            ...
            const hideGrid = () => {
                ...
                Flip.from(flipstate1, {
                    ...
                    borderRadius: '12px',
                    onComplete: function() {
                        gsap.set($('.showcase-gallery .section-image'), {
                            borderRadius: ""
                        });
                    }
                }, 0)
                ...
                if ($(".showcase-gallery .slider-fixed-content #slide-inner-caption").hasClass("height-title")) {
                    ...
                    gsap.set($(".showcase-gallery .slider-fixed-content .slide-hero-subtitle.caption-timeline span"), {
                        y: 100
                    });
                    gsap.to($(".showcase-gallery .slider-fixed-content .slide-hero-subtitle.caption-timeline span"), {
                        duration: 0.7,
