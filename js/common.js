    ...
    window.ScrollEffects = function() {
        ...
        if ($('#hero').hasClass('has-image')) {
            ...
            function setHeroProperties() {
                gsap.set("#hero-caption.height-title", {
                    height: window.innerHeight
                });
            }
        ...
        imagesLoaded('body', function() {
            ...
            const marqueeBw = roll(".marquee-text.bw", {
                duration: 20
            }, true);
        ...
        function setPageNavProperties() {
            gsap.set(".page-nav-caption.height-title", {
                height: window.innerHeight - $('footer').height()
            });
        }
